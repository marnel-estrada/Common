...
namespace CommonEcs {
    public struct ComputeBufferSpriteManager : ISharedComponentData {
        ...
        private class Internal {
            ...
            public Mesh quad; // The single quad that we need
            ...
            private readonly NativeArray<float4> uvValues;
