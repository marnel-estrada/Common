...
namespace GoapBrainEcs {
    /// <summary>
    /// A test where a chain of actions is being executed but the one at the middle failed
    /// </summary>
    public class SecondAtomActionFailed : GoapExecutionTestTemplate {
        // Conditions
        ...
        public SecondAtomActionFailed(World world, EntityManager entityManager) : base(world, entityManager) {
        }
        ...
        protected override void DoAssertions(EntityManager entityManager) {
            ...
            // We check for 2 here to see if it reached the second action
