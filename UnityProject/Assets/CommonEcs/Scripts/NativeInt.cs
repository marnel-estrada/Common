...
namespace CommonEcs {
    ...
    public unsafe struct NativeInt : IDisposable {
        ...
        public struct Parallel {
            ...
            public void Increment() {
                RequireWriteAccess();
                this.m_Buffer[IntsPerCacheLine * this.m_ThreadIndex]++;
            }
            ...
            public void Add(int value) {
                RequireWriteAccess();
                this.m_Buffer[IntsPerCacheLine * this.m_ThreadIndex] += value;
            }
        ...
        /// </param>
        public NativeInt(Allocator allocator, int initialValue = 0) {
            ...
            this.m_Buffer = (int*) UnsafeUtility.Malloc(JobsUtility.CacheLineSize * JobsUtility.MaxJobThreadCount,
        ...
        public int Value {
            get {
                ...
                for (int i = 0; i < JobsUtility.MaxJobThreadCount; ++i) {
                    value += this.m_Buffer[IntsPerCacheLine * i];
                }
            ...
            set {
                ...
                *this.m_Buffer = value;
                for (int i = 1; i < JobsUtility.MaxJobThreadCount; ++i) {
                    this.m_Buffer[IntsPerCacheLine * i] = 0;
                }
            }
        }

        /// <summary>
        /// Converts a NativeInt into an int
        /// </summary>
        /// <param name="source"></param>
        /// <returns></returns>
        public static implicit operator int(NativeInt source) {
            return source.Value;
        }
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            Parallel parallel = new Parallel(this.m_Buffer, this.m_Safety);
    ...
    internal sealed class NativePerJobThreadIntPtrDebugView {
        ...
        /// The object to provide a debugger view for
        /// </param>
        public NativePerJobThreadIntPtrDebugView(NativeInt ptr) {
            this.m_Ptr = ptr;
        }
