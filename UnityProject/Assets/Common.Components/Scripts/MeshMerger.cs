    ...
    public class MeshMerger : MonoBehaviour {
        ...
        private void Start() {
            ...
            if (this.meshFilters.Length == 0) {
                ...
                this.meshFilters = new MeshFilter[comps.Length];

                int mfi = 0;
                foreach (Component comp in comps) {
                    this.meshFilters[mfi++] = (MeshFilter) comp;
                }
            }
            ...
            foreach (MeshFilter mf in this.meshFilters) {
                ...
                if (this.material == null) {
                    this.material = mf.gameObject.GetComponent<Renderer>().material;
                }
            }
            ...
            Transform[] aBones = new Transform[this.meshFilters.Length];
            Matrix4x4[] bindPoses = new Matrix4x4[this.meshFilters.Length];
            ...
            foreach (MeshFilter mf in this.meshFilters) {
                ...
                MeshRenderer mr = mf.gameObject.GetComponent(typeof(MeshRenderer)) as MeshRenderer;
                if (mr != null) {
                    mr.enabled = false;
                }
            }
            ...
            SkinnedMeshRenderer smr = this.gameObject.AddComponent(typeof(SkinnedMeshRenderer)) as SkinnedMeshRenderer;
