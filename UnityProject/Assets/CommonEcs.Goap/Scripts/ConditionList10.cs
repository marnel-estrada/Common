...
namespace CommonEcs.Goap {
    ...
    public unsafe struct ConditionList10 {
        ...
        private readonly Condition m_Element5;

        private readonly Condition m_Element6;

        private readonly Condition m_Element7;

        private readonly Condition m_Element8;

        private readonly Condition m_Element9;
