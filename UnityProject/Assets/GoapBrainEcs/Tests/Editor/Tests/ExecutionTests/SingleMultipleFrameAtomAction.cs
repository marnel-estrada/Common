...
namespace GoapBrainEcs {
    public class SingleMultipleFrameAtomAction : GoapExecutionTestTemplate {
        // Conditions
        ...
        public SingleMultipleFrameAtomAction(World world, EntityManager entityManager) : base(world, entityManager) {
        }
        ...
        protected override void PrepareDomain() {
            ...
            AtomActionSet actionSet = new AtomActionSet(new IncrementCounterUntilComposer(MAX_VALUE));
